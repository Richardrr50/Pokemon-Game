...
public class Game {
	...
	private static Pokemon chooseFirstPokemon() {
		...
		if (input1 == 1) {
			...
			System.out.println("congratulations! you chose Charmander");
		} else if (input1 == 2) {
			firstPokemon = PokemonData.BULBASAUR;

			System.out.println("congratulations! you chose Bulbasaur");
		} else if (input1 == 3) {
			firstPokemon = PokemonData.SQUIRTLE;

			System.out.println("congratulations! you chose Squirtle");
		} else {
